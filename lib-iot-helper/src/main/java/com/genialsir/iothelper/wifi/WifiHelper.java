...
public class WifiHelper {
    ...
    public static int configOrCreateWifi(WifiManager manager, String wifiSSID, String password, String safetyCategory) {
        WifiConfiguration configuration = createWifiConfiguration(wifiSSID, password, safetyCategory);
        return saveWifiConfiguration(manager, configuration);
    }
    ...
    private static WifiConfiguration createWifiConfiguration(String wifiName, String password, String safetyCategory) {
        ...
        } else if (WPA.equals(safetyCategory)) {
            configuration.hiddenSSID = true;
            configuration.preSharedKey = "\"" + password + "\"";
    ...
    private static WifiConfiguration createWifiConfiguration(IWifi wifi, String password) {
        ...
        if (password == null) {
            ...
            configuration.allowedProtocols.clear();
            configuration.SSID = wifi.SSID();
            Log.d("WifiHelper", "wifi.SSID : " + wifi.SSID());
            if (wifi.capabilities().contains(WEP)) {
                configuration.preSharedKey = "\"" + password + "\"";
                configuration.hiddenSSID = true;
                configuration.allowedAuthAlgorithms.set(WifiConfiguration.AuthAlgorithm.SHARED);
