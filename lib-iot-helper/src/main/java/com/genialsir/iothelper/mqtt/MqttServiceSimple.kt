 ...
 */
class MqttServiceSimple : Service() {

    private val TAG = MqttServiceSimple::class.java.toString()
    ...
    companion object {
        ...
        fun start(context: Context) {
            val intent = Intent(context, MqttServiceSimple::class.java)
        ...
        fun stop(context: Context) {
            context.stopService(Intent(context, MqttServiceSimple::class.java))
        }
    }
