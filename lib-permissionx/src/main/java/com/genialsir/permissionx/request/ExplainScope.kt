...
/**
 * Provide specific scopes for [com.genialsir.permissionx.callback.ExplainReasonCallback]
 * and [com.genialsir.permissionx.callback.ExplainReasonCallbackWithBeforeParam] to give it specific functions to call.
 * @author guolin
 * @since 2020/3/18
 */
